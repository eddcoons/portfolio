...
var hourlyCheck = true;
var annualCheck = false;
...
window.calculateSalary = function () {
    ...
    var hoursWeek = document.getElementById("hoursWeek").value;
    var weeksYear = document.getElementById("weeksYear").value;
    ...
    if (hourlyCheck === true) {
        var annualSalaryValue = hourlyWage * hoursWeek * weeksYear;
        document.getElementById("annualSalary").value = Math.trunc(annualSalaryValue);
    } else {
        var hourlyWageValue = annualSalary / weeksYear / hoursWeek;
        document.getElementById("hourlyWage").value = Math.trunc(hourlyWageValue);
    }
};

window.showOptions = function () {
    var toggleItems = document.getElementById("toggle-items");
